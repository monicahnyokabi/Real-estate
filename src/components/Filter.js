      ...
      <section id="filter">
        <div className="inside">
          ...
          <div className="filters extras">
            ...
            <label htmlFor="extras">
              <span>Pets</span>
              <input type="checkbox" name="pets" value="pets" onChange={this.props.change} />
            </label>
            <label htmlFor="extras">
              <span>Playing Ground</span>
              <input type="checkbox" name="playing ground" value="playing ground" onChange={this.props.change} />
            </label>
          </div>
        </div>
      </section>
